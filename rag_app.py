...
model = SentenceTransformer("BAAI/bge-base-en-v1.5")  # Let model handle device internally
...
query = st.text_input("Question", placeholder="e.g. What warm-up drills help reduce shoulder pain?", key="input")
